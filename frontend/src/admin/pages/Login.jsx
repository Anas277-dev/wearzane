...
//                 <h2 className="text-3xl font-bold mb-6 text-center tracking-widest">WEARZANE</h2>
//                 <form onSubmit={handleLogin} className="space-y-4">
//                     <input type="email" placeholder="Admin Email" className="w-full p-3 border rounded" 
...
import axios from 'axios';
import { useNavigate } from 'react-router-dom';
import { FiMail, FiLock, FiEye, FiEyeOff, FiArrowRight, FiCheckCircle, FiShield } from 'react-icons/fi';
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 xl:p-16 text-white w-full">
          ...
          <div className="space-y-6 max-w-md">
            <h2 className="text-3xl xl:text-4xl font-light leading-tight">
              Control center for the WearZane catalog.
            </h2>
            <div className="space-y-3">
              {['Manage products, orders & staff', 'Monitor activity in real time', 'Secure, role-based access'].map((perk) => (
      ...
      <div className="flex-1 flex items-center justify-center px-4 sm:px-8 py-12 sm:py-16">
        <div className="w-full max-w-sm">
          ...
          <header className="mb-8">
            <p className="text-[10px] font-bold tracking-[0.3em] uppercase text-[#1B4332]/60 mb-2 flex items-center gap-1.5">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <div>
              <label className="block text-[10px] font-bold uppercase tracking-widest text-gray-400 mb-1.5">Admin Email</label>
              <div className="relative">
                <FiMail className="absolute left-4 top-1/2 -translate-y-1/2 text-[#1B4332]/40 text-sm" />
                <input
                  type="email" required
                  placeholder="admin@wearzane.com"
