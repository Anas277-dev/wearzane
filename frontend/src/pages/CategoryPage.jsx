...
//         <h1 className="text-3xl font-light tracking-[0.2em] uppercase italic text-gray-800">{categoryName} Collection</h1>
//         <div className="h-1 w-16 bg-black mx-auto mt-2"></div>
//       </header>

//       <PriceFilter 
//         onFilter={fetchCategoryProducts} 
//         currentMin={minPrice} 
//         currentMax={maxPrice}
//         setMin={setMinPrice}
//         setMax={setMaxPrice}
...
//       {loading ? (
//         <div className="text-center p-20 text-xl font-light uppercase tracking-widest animate-pulse">Loading {categoryName}...</div>
//       ) : products.length > 0 ? (
//         <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-6 gap-y-10">
//           {products.map((product) => <ProductCard key={product.id} product={product} />)}
//         </div>
//       ) : (
//         <div className="text-center py-20 text-gray-400 italic font-light tracking-widest uppercase">No items found in this range.</div>
//       )}
//     </div>
//   );
// };
