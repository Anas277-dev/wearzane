...
//     try {
//       const res = await axios.post(`http://localhost:5000/api/cart`, { productId: id }, {
...
//   if (loading) return <div className="text-center p-20 text-xl font-light uppercase tracking-widest animate-pulse">Loading Piece Details...</div>;
//   if (!product) return <div className="text-center p-20 text-gray-500 italic">Product not found.</div>;

//   return (
//     <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-16">
//       <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
//         <div className="lg:col-span-7 flex flex-col-reverse md:flex-row gap-4">
//           <div className="flex md:flex-col gap-3 overflow-x-auto md:overflow-x-visible justify-start">
//             {product.images && product.images.map((img, idx) => (
//               <button 
//                 key={idx} 
//                 onClick={() => setActiveImage(img)}
//                 className={`w-20 aspect-[3/4] overflow-hidden bg-gray-100 border flex-shrink-0 transition-all ${
//                   activeImage === img ? 'border-black scale-95' : 'border-gray-200 opacity-70 hover:opacity-100'
//                 }`}
//               >
...
//             ))}
//           </div>
//           <div className="flex-1 aspect-[3/4] bg-gray-50 overflow-hidden border border-gray-100 rounded-sm">
//             <img src={activeImage || 'https://via.placeholder.com/600x800'} alt={product.name} className="w-full h-full object-cover" />
//           </div>
//         </div>

//         <div className="lg:col-span-5 flex flex-col justify-start space-y-6 lg:pl-4">
//           <div>
//             <span className="text-[10px] font-black tracking-[0.3em] uppercase text-gray-400">{product.section} Wear</span>
//             <h1 className="text-3xl font-light text-gray-900 uppercase tracking-wide mt-1">{product.name}</h1>
            
//             {reviewsData.stats.total_reviews > 0 && (
//               <div className="flex items-center gap-2 mt-2">
//                 {renderStars(reviewsData.stats.avg_rating)}
//                 <span className="text-xs font-bold text-gray-600">{reviewsData.stats.avg_rating} / 5</span>
//                 <span className="text-xs text-gray-400">({reviewsData.stats.total_reviews} Reviews)</span>
//               </div>
//             )}
//             <p className="text-xl font-black text-gray-900 mt-3">Rs. {product.price}</p>
...
//                 className="w-full bg-black text-white py-4 text-xs font-bold tracking-[0.2em] uppercase hover:bg-gray-800 disabled:bg-gray-300 transition"
//               >
...
//                 className="w-full bg-gray-200 text-black border border-black py-4 text-xs font-bold tracking-[0.2em] uppercase hover:bg-black hover:text-white transition"
//               >
//                 Login To Purchase
//               </button>
//             )}
...
//         </div>
//       </div>
//       {/* Rest of the code for Reviews remains same */}
//       <div className="pt-10 border-t border-gray-200 grid grid-cols-1 lg:grid-cols-2 gap-12">
//         <div>
//           <header className="mb-6">
//             <h2 className="text-xl font-light tracking-widest uppercase text-gray-800">Customer Reviews</h2>
//             <div className="h-0.5 w-12 bg-black mt-1"></div>
//           </header>
...
//                 <div key={review.id} className="border border-gray-100 p-5 rounded-sm bg-gray-50/50">
//                   <div className="flex justify-between items-center mb-2">
//                     <span className="text-xs font-bold uppercase tracking-tight text-gray-900">{review.customer_name}</span>
//                     {renderStars(review.rating)}
//                   </div>
//                   <p className="text-xs text-gray-600 font-light italic">"{review.comment}"</p>
//                 </div>
//               ))}
//             </div>
//           )}
...
//         <div className="bg-gray-50/60 p-6 border rounded-sm flex flex-col justify-center">
//           <header className="mb-6">
//             <h2 className="text-xl font-light tracking-widest uppercase text-gray-800">Write A Review</h2>
//             <div className="h-0.5 w-12 bg-black mt-1"></div>
//           </header>
...
//               {formMessage.text && (
//                 <div className={`p-3 text-xs font-bold uppercase tracking-wider ${formMessage.type === 'success' ? 'bg-emerald-50 text-emerald-700 border border-emerald-200' : 'bg-red-50 text-red-700 border border-red-200'}`}>
//                   {formMessage.text}
//                 </div>
//               )}
              
//               <div>
//                 <label className="block text-[10px] font-bold uppercase tracking-widest text-gray-400 mb-1">Your Rating</label>
...
//                         type="button"
//                         key={index}
//                         className={`text-2xl transition-colors ${starValue <= (hoverRating || rating) ? 'text-amber-500' : 'text-gray-300'}`}
...
//               <div>
//                 <label className="block text-[10px] font-bold uppercase tracking-widest text-gray-400 mb-1">Your Name</label>
//                 <input type="text" required value={customerName} onChange={(e) => setCustomerName(e.target.value)} placeholder="e.g. Anas Siddiqui" className="w-full p-3 border text-xs bg-white outline-none focus:border-black" />
//               </div>

//               <div>
//                 <label className="block text-[10px] font-bold uppercase tracking-widest text-gray-400 mb-1">Comments / Review</label>
//                 <textarea rows="4" required value={comment} onChange={(e) => setComment(e.target.value)} placeholder="Tell us about fabric quality..." className="w-full p-3 border text-xs bg-white outline-none focus:border-black resize-none"></textarea>
//               </div>

//               <button type="submit" className="w-full bg-black text-white py-3 text-[10px] font-bold tracking-[0.2em] uppercase hover:bg-gray-800 transition">
//                 Submit Review
//               </button>
//             </form>
//           ) : (
...
//               <button 
//                 onClick={() => navigate('/login')} 
//                 className="bg-black text-white px-8 py-3 text-xs font-bold tracking-widest uppercase hover:bg-gray-800 transition"
//               >
