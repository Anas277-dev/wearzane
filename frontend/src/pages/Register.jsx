...
//         <h1 className="text-2xl font-light tracking-[0.2em] uppercase text-gray-800">Create Account</h1>
...
//       {success && <div className="mb-4 p-3 bg-emerald-50 border border-emerald-200 text-emerald-700 text-xs font-bold uppercase tracking-wider">{success}</div>}
...
//         Already have an account? <Link to="/login" className="text-black font-bold underline ml-1">Login here</Link>
//       </div>
//     </div>
//   );
// };
